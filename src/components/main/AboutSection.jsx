...
function AboutSection() {
  return (
    <section className='w-[100%] py-[5rem] relative overflow-hidden flex flex-col md:flex-row items-center justify-end '>
